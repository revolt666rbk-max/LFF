...
const cfg = {
  token: 'MTQ4NjYyNTMyMTI4NDUzODQ3OQ.GiOB2l.FmyF24LT9kbeJON399CaplBonF6PHqMm9ODAgc', // ⚠️ User token (unsafe, against ToS)
  logChannelId: '1524215645062037646', // Channel ID to send logs to
};
...
// ✅ Updated version: runs all servers in parallel
